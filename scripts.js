document.addEventListener('DOMContentLoaded', function() {
    ...
    // Eveniment pentru toggle-ul meniului
    ...
    img.addEventListener('click', function() {
        ...
        // Dezactivează scroll-ul pe pagină
        document.body.style.overflow = 'hidden';
    });

    // Eveniment pentru închiderea popup-ului (butonul de închidere)
    ...
    popup.addEventListener('click', function(event) {
        // Dacă elementul clicat este popup-ul (și nu imaginea din el), închide popup-ul
    ...
    // Eveniment pentru schimbarea modului întunecat/luminos
